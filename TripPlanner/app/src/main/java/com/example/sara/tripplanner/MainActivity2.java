...
;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /// UserEmail=(TextView)findViewById(R.id.userEmail);
        ...
        reference = database.getReference("Trip2").child(user.getUid());
    ...
    public void getValues2(){
        ...
        aprogress.show();
        trip2obj1=new Trip2way(Name,Date,Time,PlaceForm,PlaceTo);
        reference.push().setValue(trip2obj1);
        trip2obj2=new Trip2way(Date2,Time2,PlaceForm2,PlaceTo2);
        reference2.push().setValue(trip2obj2);
